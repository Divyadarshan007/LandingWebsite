                    ...
                    <div className="row gy-5">
                        <div className="col-lg-6 col-12">
                            <div className="text-lg-start text-center">
                                ...
                                <h1 className="text-white display-4">The Best Free Online Courses of All Time</h1>
                                ...
                                <div className="d-flex flex-wrap gap-3 justify-content-lg-start justify-content-center align-items-center">
                        ...
                        <div className="col-lg-6 col-12">
                            <div className="image">
                                <img src="/images/hero_banner_img_1.jpg" className="rounded-3" width={'100%'} alt="" />
                            </div>
                        </div>
                    </div>
                </div>
